...
def conv_1x3x3_bn(inp, oup, stride):
    return nn.Sequential(
        nn.Conv3d(inp, oup, 3, (1, stride, stride), 1, bias=False),
        nn.BatchNorm3d(oup),
...
class Mobilenet_36(nn.Module):
    def __init__(self, n_class=101, in_channel=3, input_size=224, width_mult=1.):
        super(Mobilenet_36, self).__init__()
        # setting of inverted residual blocks
        self.interverted_residual_setting = [
            # t, c, n, s
            [1, 16, 1, 1],
