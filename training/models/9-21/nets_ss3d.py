...
class Mixed_3b(nn.Module):
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            ...
            BasicConv3d(96, 128, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(128, 128, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch2 = nn.Sequential(
            BasicConv3d(self.groups[2], 16, kernel_size=1, stride=1),
            BasicConv3d(16, 32, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(32, 32, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
...
class Mixed_3c(nn.Module):
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            ...
            BasicConv3d(128, 192, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(192, 192, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch2 = nn.Sequential(
            BasicConv3d(self.groups[2], 32, kernel_size=1, stride=1),
            BasicConv3d(32, 96, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(96, 96, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch3 = nn.Sequential(
            nn.MaxPool3d(kernel_size=(3, 3, 3), stride=1, padding=1),
...
class Mixed_4b(nn.Module):
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            BasicConv3d(self.groups[1], 96, kernel_size=1, stride=1),
            BasicConv3d(96, 208, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(208, 208, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch2 = nn.Sequential(
            BasicConv3d(self.groups[2], 16, kernel_size=1, stride=1),
            BasicConv3d(16, 48, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(48, 48, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch3 = nn.Sequential(
            nn.MaxPool3d(kernel_size=(3, 3, 3), stride=1, padding=1),
            BasicConv3d(self.groups[3], 64, kernel_size=1, stride=1),
...
class Mixed_4c(nn.Module):
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            ...
            BasicConv3d(112, 224, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(224, 224, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch2 = nn.Sequential(
            BasicConv3d(self.groups[2], 24, kernel_size=1, stride=1),
            BasicConv3d(24, 64, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(64, 64, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch3 = nn.Sequential(
            nn.MaxPool3d(kernel_size=(3, 3, 3), stride=1, padding=1),
            BasicConv3d(self.groups[3], 64, kernel_size=1, stride=1),
...
class Mixed_4d(nn.Module):
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            BasicConv3d(self.groups[1], 128, kernel_size=1, stride=1),
            BasicConv3d(128, 256, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(256, 256, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch2 = nn.Sequential(
            BasicConv3d(self.groups[2], 24, kernel_size=1, stride=1),
            BasicConv3d(24, 64, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
...
class Mixed_4e(nn.Module):
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            ...
            BasicConv3d(144, 288, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(288, 288, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch2 = nn.Sequential(
            BasicConv3d(self.groups[2], 32, kernel_size=1, stride=1),
            BasicConv3d(32, 64, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(64, 64, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch3 = nn.Sequential(
            nn.MaxPool3d(kernel_size=(3, 3, 3), stride=1, padding=1),
...
class Mixed_4f(nn.Module):
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            ...
            BasicConv3d(160, 320, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(320, 320, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch2 = nn.Sequential(
            BasicConv3d(self.groups[2], 32, kernel_size=1, stride=1),
            BasicConv3d(32, 128, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(128, 128, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch3 = nn.Sequential(
            nn.MaxPool3d(kernel_size=(3, 3, 3), stride=1, padding=1),
...
class Mixed_5c(nn.Module):
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            ...
            BasicConv3d(192, 384, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(384, 384, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch2 = nn.Sequential(
            BasicConv3d(self.groups[2], 48, kernel_size=1, stride=1),
            BasicConv3d(48, 128, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
            BasicConv3d(128, 128, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
        )
        self.branch3 = nn.Sequential(
            nn.MaxPool3d(kernel_size=(3, 3, 3), stride=1, padding=1),
...
class SS3D(nn.Module):
    ...
    def __init__(self, num_classes=400, input_channel=3, dropout_keep_prob=0.0):
        ...
        self.features = nn.Sequential(
            ...
            BasicConv3d(64, 192, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),  # (192, 32, 56, 56)
            BasicConv3d(192, 192, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
