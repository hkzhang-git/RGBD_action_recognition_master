...
# I3D
train_val_info_dir = root + 'train_info_I3D.txt'
...
# S3D
train_val_info_dir = root + 'train_info_S3D.txt'
train_val_info = open(train_val_info_dir).readlines()
...
# SS3D
train_val_info_dir = root + 'train_info_SS3D_2.txt'
train_val_info = open(train_val_info_dir).readlines()
...
# GSS3D
train_val_info_dir = root + 'train_info_GSS3D_2.txt'
train_val_info = open(train_val_info_dir).readlines()
...
im_name = './img/' + 'I3D_S3D_SS3D2_GSS3D2_depth_acc.jpg'
